...
def depth2(controller, speed):
        #print depth
        mmvert.setMotorSpeed(speed)
        
        showmotor(controller, 6, speed)
...
def side(controller, speed):
        #print starboard
        mmside.setMotorSpeed(speed)
        
        showmotor(controller, 8, speed)
...
def motortest():
        mleft.setMotorSpeed(255)
        mright.setMotorSpeed(255)
        mvert.setMotorSpeed(255)
        mmvert.setMotorSpeed(255)
        mmside.setMotorSpeed(255)
        time.sleep(1)
        mleft.setMotorSpeed(0)
        mright.setMotorSpeed(0)
        mvert.setMotorSpeed(0)
        mmvert.setMotorSpeed(0)
        mmside.setMotorSpeed(0)
...
mmvert = dw.getMotor(4)
mmside = dw.getMotor(5)
        ...
        for ps in controllerlist:
                ...
                if ps.l1:
                        if (time.time() - ps.lastbuttontime) > BUTTON_LAG or ps.lastbuttontime == 0:
                                ps.lastbuttontime = time.time()
                                motordepth2 = -255
                                if motordepth2 != ps.lastvert2:
                                        ps.lastvert2 = motordepth2
                                        depth2(ps, motordepth2)
                elif ps.l2:
                        if (time.time() - ps.lastbuttontime) > BUTTON_LAG or ps.lastbuttontime == 0:
                                ps.lastbuttontime = time.time()
                                motordepth2 = 255
                ...
                if ps.left:
                        if (time.time() - ps.lastbuttontime) > BUTTON_LAG or ps.lastbuttontime == 0:
                                ps.lastbuttontime = time.time()
                                motorside = -255
                                if motorside != ps.lastside:
                                        ps.lastside = motorside
                                        side(ps, motorside)
                elif ps.right:
                        if (time.time() - ps.lastbuttontime) > BUTTON_LAG or ps.lastbuttontime == 0:
                                ps.lastbuttontime = time.time()
